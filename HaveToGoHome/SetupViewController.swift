...
class SetupViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SetLocation, NotifySetupViewDelegate {
    ...
    func setSelectedLocation(valueSent: String) {
        setupModel.setUserHomeLocation(locationLabel: valueSent, locationData: nil)
